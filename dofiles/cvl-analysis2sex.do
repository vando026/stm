...
egen HIV_pcat_Male = cut(HIV_Prev_Male), at(0, 2.5, 5, 10, 25) icode label
...
** Set 2  no adjust for HIV prevalence
...
** Set 3 adjust for HIV prevalence
foreach mod of global PCVLm {
